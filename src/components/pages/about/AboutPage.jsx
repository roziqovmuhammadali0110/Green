  ...
  return (
    <div>
      <div className="p-4 xs:p-1 md:p-4 xs:text-sm md:text-lg text-gray-700">
        ...
        акарицидлар), органик ҳамда минерал ўғитлар, биостимуляторлар ишлаб
        чиқарилади ва тарқатилади. Компаниянинг мақсади — фермерлар ва деҳқон
        хўжаликларини замонавий воситалар билан таъминлаш орқали қишлоқ хўжалик
        экинларини ҳимоя қилиш, ҳосилдорликни ошириш ва маҳсулот сифатини янада
        юқори даражага кўтаришдан иборат. Шу билан бирга, атроф-муҳитга зарар
        етказмаслик ҳам асосий тамойиллардан биридир. Биз доимий равишда
        инновацион ечимларни жорий этиш ва фермерларнинг меҳнатини самарали
        қилиш учун барча имкониятларни ишга соламиз. Ҳар бир фермер ва деҳқон
        учун ишончли ҳамкор бўлишга интилмоқдамиз.
      </div>
